...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            case 1:
                filteredImage = ApplyOutlineFilterParallel(image);
                Console.WriteLine("Filtrul Outline a fost aplicat (paralel).");
                break;
            case 2:
                filteredImage = ApplyGrayscaleFilterParallel(image);
                Console.WriteLine("Filtrul Grayscale a fost aplicat (paralel).");
                break;
            case 3:
                filteredImage = ApplySepiaFilterParallel(image);
                Console.WriteLine("Filtrul Sepia a fost aplicat (paralel).");
                break;
            case 4:
                filteredImage = ApplyNegativeFilterParallel(image);
                Console.WriteLine("Filtrul Negative a fost aplicat (paralel).");
                break;
            default:
    ...
    public static Bitmap ApplyOutlineFilterParallel(Bitmap image)
    {
    ...
    public static Bitmap ApplyGrayscaleFilterParallel(Bitmap image)
    {
    ...
    public static Bitmap ApplySepiaFilterParallel(Bitmap image)
    {
    ...
    public static Bitmap ApplyNegativeFilterParallel(Bitmap image)
    {
